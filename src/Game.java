...
class Game {
    ...
    public void resetBoard() {
        ...
        class Player implements Runnable {
            //represents the socket through which  the player communicates with the game server
            Socket socket;
            //used for reading input from the socket
            Scanner input;
            //used for sending output to the socket
            PrintWriter output;
            //stores the name of players
            String playerName;
            //Opponent player
            Player opponent;
            //represents the player number (1 or 2 ) in a multiplayer game
            Integer playerNum;
